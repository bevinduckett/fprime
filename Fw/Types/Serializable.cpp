...
ALWAYS_INLINE SerializeStatus LinearBufferBase::deserializeTo(U64& val, Endianness mode) {
    ...
    switch (mode) {
        case Endianness::BIG:
            // MSB first
            val = (static_cast<U64>(this->m_buffAddr[this->m_deserLoc + 7]) << 0) |
                  (static_cast<U64>(this->m_buffAddr[this->m_deserLoc + 6]) << 8) |
                  (static_cast<U64>(this->m_buffAddr[this->m_deserLoc + 5]) << 16) |
                  (static_cast<U64>(this->m_buffAddr[this->m_deserLoc + 4]) << 24) |
                  (static_cast<U64>(this->m_buffAddr[this->m_deserLoc + 3]) << 32) |
                  (static_cast<U64>(this->m_buffAddr[this->m_deserLoc + 2]) << 40) |
                  (static_cast<U64>(this->m_buffAddr[this->m_deserLoc + 1]) << 48) |
                  (static_cast<U64>(this->m_buffAddr[this->m_deserLoc + 0]) << 56);
            break;
        case Endianness::LITTLE:
            // LSB first
            val = (static_cast<U64>(this->m_buffAddr[this->m_deserLoc + 0]) << 0) |
                  (static_cast<U64>(this->m_buffAddr[this->m_deserLoc + 1]) << 8) |
                  (static_cast<U64>(this->m_buffAddr[this->m_deserLoc + 2]) << 16) |
                  (static_cast<U64>(this->m_buffAddr[this->m_deserLoc + 3]) << 24) |
                  (static_cast<U64>(this->m_buffAddr[this->m_deserLoc + 4]) << 32) |
                  (static_cast<U64>(this->m_buffAddr[this->m_deserLoc + 5]) << 40) |
                  (static_cast<U64>(this->m_buffAddr[this->m_deserLoc + 6]) << 48) |
                  (static_cast<U64>(this->m_buffAddr[this->m_deserLoc + 7]) << 56);
            break;
        default:
            FW_ASSERT(false);
            break;
...
ALWAYS_INLINE const U8* LinearBufferBase::getBuffAddrLeft() const {
    FW_ASSERT(this->m_buffAddr);
    return &this->m_buffAddr[this->m_deserLoc];
}
